...
class PiApplication(object):
    ...
    def touch_screen_points(self, events):
        ...
        middle_bottom_left = pygame.Rect(0, window_area.height * 0.50, window_area.width * 0.15, window_area.height * 0.35)
        bottom_left = pygame.Rect(0, window_area.height * 0.85, window_area.width * 0.15, window_area.height * 0.15)
        center_top_left = pygame.Rect(window_area.width * 0.15, 0, window_area.width * 0.35, window_area.height * 0.15)
        center_left = pygame.Rect(window_area.width * 0.15, window_area.height * 0.15, window_area.width * 0.35, window_area.height * 0.7)        
        center_bottom_left = pygame.Rect(window_area.width * 0.15, window_area.height * 0.85, window_area.width * 0.35, window_area.height * 0.15)
        center_top_right = pygame.Rect(window_area.width * 0.5, 0, window_area.width * 0.35, window_area.height * 0.15)
        center_right = pygame.Rect(window_area.width * 0.5, window_area.height * 0.15, window_area.width * 0.35, window_area.height * 0.7)
        center_bottom_right = pygame.Rect(window_area.width * 0.5, window_area.height * 0.85, window_area.width * 0.35, window_area.height * 0.15)
        top_right = pygame.Rect(window_area.width * 0.85, 0, window_area.width * 0.15, window_area.height * 0.15)       
        middle_top_right = pygame.Rect(window_area.width * 0.85, window_area.height * 0.15, window_area.width * 0.15, window_area.height * 0.35)
        middle_bottom_right = pygame.Rect(window_area.width * 0.85, window_area.height * 0.50, window_area.width * 0.15, window_area.height * 0.35)
        bottom_right = pygame.Rect(window_area.width * 0.85, window_area.height * 0.85, window_area.width * 0.15, window_area.height * 0.15)     
